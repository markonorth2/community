...
module.exports = (db) => {
  ...
  router.post("/new", (req, response) => {
    ...
    const { category_id, name, city, province_state, country, street_address } =
      req.body;

    console.log("re.body", req.body);

    db.query(
      `INSERT INTO businesses (category_id, name, city, province_state, country, street_address)
      VALUES ($1, $2::text, $3::text, $4::text, $5::text, $6::text) RETURNING id
    `,
      [category_id, name, city, province_state, country, street_address]
    )
      .then((res) => {
        console.log("business insert", res.rows);
  ...
  router.delete("/:id", (req, res) => {
    db.query(`DELETE FROM businesses WHERE id = $1::integer`, [req.params.id]);
  });
